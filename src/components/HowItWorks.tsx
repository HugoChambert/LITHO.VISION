...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="min-h-screen py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 relative overflow-hidden">
      <AnimatedGradient />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-16 sm:mb-20 md:mb-28 lg:mb-32">
          <ScrollReveal delay={0}>
            <div className="p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border border-white/10 hover-lift group cursor-default relative overflow-hidden"
                 style={{
