  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-auto">
        ...
        >
          {isMobile ? (
            <span className="inline-block" style={{ textShadow: '0 0 40px rgba(59, 130, 246, 0.3)' }}>
              LITHOVISION
            </span>
          ) : (
        ...
        <motion.p
          className="text-xl md:text-2xl lg:text-3xl text-white/90 tracking-wide select-none pointer-events-none px-4 text-center"
          style={{
            fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif',
            fontWeight: 300,
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: isMobile ? 0.5 : 1, delay: isMobile ? 0.3 : 0.8, ease: "easeOut" }}
        >
